...
export const profile = {
  ...
  title: '嵌入式软件开发',
  hello: '你好，我是',
  jobIntent: '求职意向：建筑机器人嵌入式软件开发（实习）',
  intro:
    '具备嵌入式全栈开发能力，能独立完成从电路原理图设计、PCB 焊接到底层驱动编写与控制算法实现的全流程。熟悉 STM32 / MSPM0G3507 平台开发，掌握 I2C、SPI、UART 等串口通信协议。5 个项目均围绕机器人运动控制展开（循迹、平衡、打靶），具备 PID 串级控制、多传感器融合等核心能力，有丰富的硬件调试与排障经验。',
