...
export const profile = {
  ...
  intro:
    '百色学院物联网工程本科在读，具备嵌入式全栈开发能力——从电路原理图设计、PCB 绘制与焊接，到底层驱动编写、串级 PID 控制算法实现，可独立完成完整项目闭环。熟悉 STM32 / MSPM0G3507 / ESP32 / K230 多平台开发，掌握 I2C、SPI、UART、CAN 等通信协议、FreeRTOS 实时系统与 RFID 应用；擅长多传感器融合、互补滤波姿态解算，并能将 YOLOv12 模型训练后部署至端侧芯片。5 个项目全部围绕机器人运动控制展开（循迹、平衡、打靶），获电赛省二等奖、蓝桥杯单片机二等奖等多项奖项，积累了丰富的硬件调试与示波器排障经验。',
  email: 'junzheng837@gmail.com',
  phone: '18777981605',
  github: 'https://github.com/junzheng837-beep',
  school: '百色学院 · 物联网工程',
  grade: '本科在读 · 2024.09 - 2028.06',
  website: 'https://junzheng837-beep.github.io/portfolio/',
  courses:
